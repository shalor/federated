...
python3.8 main_traffic_lights.py --epochs 50 --agents 5 --batch-size 128 --results-file lights --attack --attack-type LabelFlip --num-exp 50 --output-dir PC1_LIGHTS_FLIP_GO_TO_STOP_DETECT  --attack-strength 1 --seed 123213123 --allow-detection
